...
```{r echo=FALSE, fig.align='center', fig.cap="Participación formal al interior de la escuela"}
...
```{r echo=FALSE, fig.align='center', fig.cap="Participación formal cuando sea adulto(a)"}
...
```{r echo=FALSE, fig.align='center', fig.cap="Participación activista al interior de la escuela"}
...
```{r echo=FALSE, fig.align='center', fig.cap="Participación activista fuera de la escuela"}
...
```{r echo=FALSE, fig.align='center', fig.cap="Participación comunitaria al interior de la escuela"}
...
```{r echo=FALSE, fig.align='center', fig.cap="Participación comunitaria fuera de la escuela"}
